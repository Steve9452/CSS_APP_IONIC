        ...
        <div class="container">
            <div class="row justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="col-md-12 my-5" v-if="!processCompleted">
                    ...
                    <input v-model="user.userId" readonly hidden type="text" class="form-control custom-form" />
                    
                    <div class="form-group">
                        <label class="text-muted"><i class="far fa-id-card"></i>&nbsp;Carnet</label>
                        <input v-model="user.carnet" readonly type="text" class="form-control custom-form"
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="user.fname" readonly type="text" class="form-control custom-form"
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="user.lname" readonly type="text" class="form-control custom-form"
...
export default {
    ...
    async created() {
        ...
        this.user = {
                ...
                carnet: this.$router.currentRoute._value.query.correo,
                fname: this.$router.currentRoute._value.query.nombres,
                lname: this.$router.currentRoute._value.query.apellidos,
                gender: '',
                faculty: '',
                collegeCareer: '',
                profile: '',
        ...
        async Register() {
            ...
            if (validation) {
                ...
                try {
                    ...
                    const request = await fetch(API_ENDOINT + '/registrar_google', {
                        method: "POST",
                        body: JSON.stringify({
                            correo: correo,
...
.custom-form[readonly] {
    background-color: var(--ion-input-color);
}
</style>